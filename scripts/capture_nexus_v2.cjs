...
async function run() {
    ...
    console.log('Capturing Nexus V2 Dashboard...');
    ...
    try {
        ...
        await page.screenshot({ path: path.join(OUTPUT_DIR, 'nexus_v2_dashboard.png'), fullPage: true });
        console.log('Captured nexus_v2_dashboard.png');
    } catch (e) {
