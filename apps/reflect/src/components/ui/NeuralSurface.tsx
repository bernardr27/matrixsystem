...
export const NeuralSurface: React.FC<NeuralSurfaceProps> = ({
    ...
    const variants: Record<string, React.CSSProperties> = {
        glass: {
            background: 'rgba(11, 14, 20, 0.4)', // Deep void tint
            border: '1px solid rgba(255, 255, 255, 0.08)',
            boxShadow: '0 40px 80px rgba(0, 0, 0, 0.8), inset 0 1px 0 rgba(255,255,255,0.1), 0 0 40px rgba(56,189,248,0.05)', // Neon glow underlay
