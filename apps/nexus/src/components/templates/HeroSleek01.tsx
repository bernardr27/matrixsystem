                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="relative group perspective-2000">
                        ...
                        <div className="relative m-glass rounded-[var(--m-radius-lg)] p-4 rotate-x-12 group-hover:rotate-0 transition-transform duration-1000 shadow-2xl">
                            ...
                            <div className="absolute bottom-4 left-4 lg:bottom-8 lg:left-8 p-3 lg:p-4 m-glass rounded-[var(--m-radius-md)] shadow-xl animate-bounce-slow z-10">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-[var(--m-accent-emerald)]/20 flex items-center justify-center">
                                        <div className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-[var(--m-accent-emerald)] shadow-glow-emerald"></div>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-[10px] lg:text-[var(--m-text-xs)] font-bold">Secure</span>
                                        <span className="text-[8px] lg:text-[10px] text-[var(--m-fg-muted)] uppercase">Encrypted Pool</span>
                                    </div>
                                </div>
                            </div>
                        </div>
